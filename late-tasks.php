...
$total_records = $stmt->fetchColumn();
        ...
        if($total_records == 0){
    echo '<br><br><br><center><h2>Thare is no tasks Late</h2></center>';
        ...
        $query = "SELECT task_id,title ,start_date,due_date, assigned_to,assigned_by, byy.photo as byph, too.photo as toph, byy.name as byname, too.name as toname, priority, status FROM tasks t, members too, members byy WHERE 1=1 and too.id=t.assigned_to and byy.id=t.assigned_by and status != 3 and due_date < '$Now' " ;
